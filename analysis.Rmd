...
# In two words, we check if there is the .rds file,
# and if not, we create it (from csv which is created by unpacking the bz2)
# and create the 'storm' dataframe.
...
if (!file.exists("StormData.rds")) {
  ...
  # The csv file is 535.6 MB
  file.remove("StormData.csv")
}

# Load the object into workspace
if (!exists("storm")) {
