...
def get_maximum_likelihood_parameters(count_coin_r, count_coin_b,
    ...
    est_prob_coin_r = count_coin_r / (count_coin_r + count_coin_b)
    est_prob_head_r = count_head_r / count_coin_r)
    est_prob_head_b = count_head_b / count_coin_b)
    return est_prob_coin_r, est_prob_head_r, est_prob_head_b

def read_user_input(args):
    if len(args) != 5:
        prob_coin_r = float(input("Enter probability of red coin: "))
        prob_head_r = float(input("Enter probability of head for red coin: "))
        prob_head_b = float(input("Enter probability of head for blue coin: "))
        n = int(input("Enter number of coins to flip: "))
        m = int(input("Enter number of times to flip each coin: "))
    else:
