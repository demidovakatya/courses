...
if __name__ == "__main__":
    ...
    samples, _ = generate_n_samples_size_m(n, m,
                                           prob_coin_r,
                                           prob_head_r,
                                           prob_head_b)
    ...
    for i in range(1000):
        ...
        print(i, "exp_log_likelihood = %1.5f" %
              (exp_log_likelihood / len(samples)))
        print("est_prob_coin_r = %1.4f (actual = %1.4f)" %
              (est_prob_coin_r, prob_coin_r))
        print("est_prob_head_r = %1.4f (actual = %1.4f)" %
              (est_prob_head_r, prob_head_r))
        print("est_prob_head_b = %1.4f (actual = %1.4f)" %
              (est_prob_head_b, prob_head_b))
        if i > 0:
