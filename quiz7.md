...
```r
# Stand. error of sample mean (se0)
sqrt(0.86 * (1 - 0.86) / 900)
# [1] 0.01156623

# Test z-score
(0.84 - 0.86) / sqrt(0.86 * (1 - 0.86) / 900)
# [1] -1.729171

# Rejection region for a = 0.05, left-tailed
- 1.64 > -1.729
# [1] TRUE

# Corresponding p-value for z = -1.729: p = 0.0419
# It is less than a, test statistic is inside rej. region.
```
